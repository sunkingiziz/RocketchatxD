...
import vieJson from './locales/vi-VN.json';

type TTranslatedKeys = keyof typeof vieJson;
...
interface ITranslations {
	[language: string]: () => typeof vieJson;
}
...
const { languageTag } = defaultLanguage || RNLocalize.findBestAvailableLanguage(availableLanguages);

// @ts-ignore
i18n.isTranslated = (text?: string) => text in vieJson;
