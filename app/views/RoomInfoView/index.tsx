...
import insertContact from '~/lib/methods/updateContact';
...
import { SubscriptionType, TSubscriptionModel, ISubscription, IUser, IApplicationState, IUserContact } from '../../definitions';
...
class RoomInfoView extends React.Component<IRoomInfoViewProps, IRoomInfoViewState> {
	...
	renderAddUserButton = (onPress: () => void, iconName: TIconsName, text: string) => {
		const { theme } = this.props;
