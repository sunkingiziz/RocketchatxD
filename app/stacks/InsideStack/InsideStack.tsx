...
import {
	...
	PhonebookStackParamList,
	ProfileStackParamList,
	SettingsStackParamList
} from '../types';
import PhoneBook from '../../views/Phonebook';
import Contact from '../../views/Phonebook/Contact';
...
const PhoneBookStack = createStackNavigator<PhonebookStackParamList>();
const PhoneBookStackNavigator = () => {
	...
	return (
		<PhoneBookStack.Navigator
			screenOptions={{ ...defaultHeader, ...themedHeader(theme), ...StackAnimation } as StackNavigationOptions}
		>
			<PhoneBookStack.Screen name='PhoneBook' component={PhoneBook} options={{ title: 'Not work' }} />
			<PhoneBookStack.Screen name='Contact' component={Contact} />
			<PhoneBookStack.Screen name='RoomView' component={RoomView} />
		</PhoneBookStack.Navigator>
	);
};
...
const TabNavigator = () => (
	...
	>
		<Tab.Screen
			...
			options={{
				tabBarIcon: ({ color, size }) => <CustomIcon name='message' size={size} color={color} />,
		...
		<Tab.Screen
			...
			options={{
				tabBarIcon: ({ color, size }) => <CustomIcon name='user' size={size} color={color} />,
		...
		<Tab.Screen
			...
			options={{
				tabBarIcon: ({ color, size }) => <CustomIcon name='contacts' size={size} color={color} />,
				tabBarLabel: I18n.t('Phonebook')
			}}
		/>
		<Tab.Screen
			...
			options={{
				tabBarIcon: ({ color, size }) => <CustomIcon name='administration' size={size} color={color} />,
		...
		{/* 	options={{ tabBarIcon: ({ color, size }) => <CustomIcon name='settings' size={size} color={color} /> }} */}
		{/* /> */}
		<Tab.Screen
			name='DisplayPrefStackNavigator'
			component={DisplayPrefStackNavigator}
			options={{
				tabBarIcon: ({ color, size }) => <CustomIcon name='sort' size={size} color={color} />,
				tabBarLabel: I18n.t('Display')
			}}
		/>
	</Tab.Navigator>
);
