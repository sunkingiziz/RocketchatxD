...
export const getContacts = (uid: string) => sdk.get('phonebook.getContacts', { uid });

export const updateContact = (updatedContact: IUserContact) => sdk.post('phonebook.updateContact', { updatedContact });

export const insertContact = (insertedContact: IUserContact) => sdk.post('phonebook.insertContact', { uid: insertedContact.uid });

export const removeContact = (removedContact: { uid: string }) =>
	sdk.post('phonebook.removeContact', { uid: removedContact.uid });
